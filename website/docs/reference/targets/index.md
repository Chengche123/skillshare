...
| Topic | Description |
|-------|-------------|
| [Supported Targets](./supported-targets.md) | Complete list of 56+ supported AI CLIs |
...
- [Commands: target](/docs/reference/commands/target) — Target command details
